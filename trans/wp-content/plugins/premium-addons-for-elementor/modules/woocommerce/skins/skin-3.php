...
class Skin_3 extends Skin_Base {
	...
	public function register_product_rating_style() {
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}}  .premium-woocommerce li.product .star-rating' => 'color: {{VALUE}}',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}}  .premium-woocommerce li.product .star-rating::before' => 'color: {{VALUE}}',
				),
			)
		);
	...
	public function register_quick_view_controls() {
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::SWITCHER,
				'selectors' => array(
					'{{WRAPPER}} li.product a.button' => 'order: 2',
				),
			)
		);
	...
	public function register_quick_style_controls() {
		...
		// );
		//
		// $this->add_responsive_control('qv_padding',
		// [
		// 'label'      => __( 'Padding', 'premium-addons-for-elementor' ),
		// 'type'       => Controls_Manager::DIMENSIONS,
		// 'size_units' => [ 'px', 'em', '%' ],
