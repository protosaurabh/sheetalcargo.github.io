...
class Skin_1 extends Skin_Base {
	...
	public function register_product_rating_style( Widget_Base $widget ) {
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .premium-woocommerce li.product .star-rating, {{WRAPPER}} .premium-woocommerce li.product .star-rating::before' => 'color: {{VALUE}}',
				),
			)
		);
